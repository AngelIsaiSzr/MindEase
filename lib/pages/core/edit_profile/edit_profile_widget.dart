...
class _EditProfileWidgetState extends State<EditProfileWidget> {
  ...
  void initState() {
    ...
    _model.biografaTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.biography, ''));
    _model.biografaFocusNode ??= FocusNode();
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => TextFormField(
                    controller: _model.biografaTextController,
                    focusNode: _model.biografaFocusNode,
                    ...
                    maxLines: 3,
                    validator: _model.biografaTextControllerValidator
                        .asValidator(context),
                    inputFormatters: [
                      if (!isAndroid && !isiOS)
                        TextInputFormatter.withFunction((oldValue, newValue) {
